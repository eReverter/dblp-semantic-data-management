...
public class Exercise_2 {
    ...
    private static class sendMsg extends AbstractFunction1<EdgeTriplet<Integer, Integer>, Iterator<Tuple2<Object,Integer>>> implements Serializable {
        ...
        public Iterator<Tuple2<Object, Integer>> apply(EdgeTriplet<Integer, Integer> triplet) {
            ...
            Integer dstVertex = triplet.dstAttr();
            Integer newVertexValue = sourceVertex + edgeWeight;

            if (newVertexValue >= dstVertex || sourceVertex == Integer.MAX_VALUE)   {   // source vertex value is smaller than dst vertex?
                // do nothing
                return JavaConverters.asScalaIteratorConverter(new ArrayList<Tuple2<Object,Integer>>().iterator()).asScala();
            } else {
                // propagate source vertex value
                return JavaConverters.asScalaIteratorConverter(Arrays.asList(new Tuple2<Object,Integer>(triplet.dstId(),newVertexValue)).iterator()).asScala();
            }
        }
    }  
